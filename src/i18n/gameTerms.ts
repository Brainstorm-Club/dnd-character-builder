...
export const featureNamesIt: Record<string, string> = {
  ...
  'Channel Divinity: Turn Undead': 'Incanalare Divinità: Scacciare Non Morti',
  ...
  'Primal Path feature': 'Privilegio del Cammino',
  ...
  'Ranger Archetype feature': 'Privilegio dell\'Archetipo Ranger',
  'Roguish Archetype feature': 'Privilegio dell\'Archetipo Ladresco',
  ...
  'Extra Attack (2)': 'Attacco Extra (2)',
  'Extra Attack (3)': 'Attacco Extra (3)',
  ...
  'Natural Explorer improvement': 'Esploratore Nato migliorato',
  'Favored Enemy and Natural Explorer improvements': 'Nemico Prescelto ed Esploratore Nato migliorati',
  'Aura improvements': 'Aure migliorate',
}
