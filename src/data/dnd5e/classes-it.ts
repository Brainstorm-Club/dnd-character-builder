...
//
// I nomi contrassegnati con "(2014)" non esistono nell'SRD italiano perché
// il privilegio è stato rimosso o rinominato nel 2024: quelli sono resi
// seguendo le convenzioni dell'SRD.
...
/**
 * Nomi italiani dei privilegi. Quelli marcati "(2014)" nel commento non
 * compaiono nell'SRD 5.2.1 italiano, perché nel 2024 il privilegio è stato
 * rimosso o rinominato: sono resi seguendo le convenzioni dell'SRD.
 */
export const dnd5eFeatureNamesIt: Record<string, string> = {
  // Barbaro
  rage: 'Ira',
  'unarmored-defense-barb': 'Difesa senza armatura',
  'reckless-attack': 'Attacco irruento',
  'danger-sense': 'Percezione del pericolo',
  'primal-path': 'Cammino primordiale', // (2014)
  'extra-attack-barb': 'Attacco extra',
  'fast-movement': 'Movimento veloce',
  'feral-instinct': 'Istinto ferino',
  'brutal-critical-1': 'Critico brutale', // (2014)
  'brutal-critical-2': 'Critico brutale', // (2014)
  'brutal-critical-3': 'Critico brutale', // (2014)
  ...
  // Bardo
  'spellcasting-bard': 'Incantesimi',
  'bardic-inspiration': 'Ispirazione bardica',
  'jack-of-all-trades': 'Factotum',
  'song-of-rest': 'Canto di riposo', // (2014)
  'bard-college': 'Collegio bardico', // (2014)
  'expertise-bard': 'Maestria',
  'expertise-bard-10': 'Maestria',
  'font-of-inspiration': 'Fonte di ispirazione',
  countercharm: 'Controfascino',
  'magical-secrets-10': 'Segreti magici',
  'magical-secrets-14': 'Segreti magici',
  'magical-secrets-18': 'Segreti magici',
  'superior-inspiration': 'Ispirazione superiore',
  // Chierico
  'spellcasting-cleric': 'Incantesimi',
  'divine-domain': 'Dominio divino', // (2014)
  'channel-divinity': 'Incanalare divinità',
  'channel-divinity-2': 'Incanalare divinità',
  'channel-divinity-3': 'Incanalare divinità',
  'turn-undead': 'Scacciare non morti', // (2014)
  'destroy-undead-half': 'Distruggere non morti', // (2014)
  'destroy-undead-1': 'Distruggere non morti', // (2014)
  'destroy-undead-2': 'Distruggere non morti', // (2014)
  'destroy-undead-3': 'Distruggere non morti', // (2014)
  'destroy-undead-4': 'Distruggere non morti', // (2014)
  'divine-intervention': 'Intervento divino',
  'divine-intervention-improvement': 'Intervento divino migliorato',
  // Druido
  druidic: 'Druidico',
  'spellcasting-druid': 'Incantesimi',
  'wild-shape': 'Forma selvatica',
  'wild-shape-4': 'Forma selvatica',
  'wild-shape-8': 'Forma selvatica',
  'druid-circle': 'Circolo druidico', // (2014)
  'timeless-body-druid': 'Corpo senza tempo', // (2014)
  'beast-spells': 'Incantesimi bestiali',
  archdruid: 'Arcidruido',
  // Guerriero
  'fighting-style-fighter': 'Stile di combattimento',
  'second-wind': 'Recuperare energie',
  'action-surge': 'Azione impetuosa',
  'action-surge-2': 'Azione impetuosa',
  'martial-archetype': 'Archetipo marziale', // (2014)
  'extra-attack-fighter': 'Attacco extra',
  'extra-attack-2': 'Due attacchi extra',
  'extra-attack-3': 'Tre attacchi extra',
  'indomitable-1': 'Indomabile',
  'indomitable-2': 'Indomabile',
  'indomitable-3': 'Indomabile',
  // Ladro
  'expertise-rogue': 'Maestria',
  'expertise-rogue-6': 'Maestria',
  'sneak-attack': 'Attacco furtivo',
  'thieves-cant': 'Gergo ladresco',
  'cunning-action': 'Azione scaltra',
  'roguish-archetype': 'Archetipo del ladro', // (2014)
  'uncanny-dodge': 'Schivata prodigiosa',
  'evasion-rogue': 'Elusione',
  'reliable-talent': 'Dote affidabile',
  blindsense: 'Percezione cieca', // (2014)
  'slippery-mind': 'Mente sfuggente',
  elusive: 'Inafferrabile',
  'stroke-of-luck': 'Pietra della buona fortuna',
  // Mago
  'spellcasting-wizard': 'Incantesimi',
  'arcane-recovery': 'Recupero arcano',
  'arcane-tradition': 'Tradizione arcana', // (2014)
  'spell-mastery': 'Maestria negli incantesimi',
  'signature-spells': 'Incantesimi personali',
  // Monaco
  'unarmored-defense-monk': 'Difesa senza armatura',
  'martial-arts': 'Arti marziali',
  ki: 'Ki', // (2014)
  'unarmored-movement': 'Movimento senza armatura',
  'unarmored-movement-9': 'Movimento senza armatura',
  'monastic-tradition': 'Tradizione monastica', // (2014)
  'deflect-missiles': 'Deviare proiettili', // (2014)
  'slow-fall': 'Caduta lenta',
  'extra-attack-monk': 'Attacco extra',
  'stunning-strike': 'Colpo stordente',
  'ki-empowered-strikes': 'Colpi potenziati dal ki', // (2014)
  'evasion-monk': 'Elusione',
  'stillness-of-mind': 'Quiete della mente', // (2014)
  'purity-of-body': 'Purezza del corpo', // (2014)
  'tongue-of-sun-and-moon': 'Lingua del sole e della luna', // (2014)
  'diamond-soul': 'Anima di diamante', // (2014)
  'timeless-body-monk': 'Corpo senza tempo', // (2014)
  'empty-body': 'Corpo vuoto', // (2014)
  'perfect-self': 'Sé perfetto', // (2014)
  // Paladino
  'divine-sense': 'Percezione del divino', // (2014)
  'lay-on-hands': 'Imposizione delle mani',
  'fighting-style-paladin': 'Stile di combattimento',
  'spellcasting-paladin': 'Incantesimi',
  'divine-smite': 'Punizione divina', // (2014)
  'divine-health': 'Salute divina', // (2014)
  'sacred-oath': 'Giuramento sacro', // (2014)
  'extra-attack-paladin': 'Attacco extra',
  'aura-of-protection': 'Aura di protezione',
  'aura-of-courage': 'Aura di coraggio',
  'improved-divine-smite': 'Punizione divina migliorata', // (2014)
  'cleansing-touch': 'Tocco purificatore', // (2014)
  'aura-improvements': 'Ampliamento dell\'aura',
  // Ranger
  'favored-enemy': 'Nemico prescelto',
  'favored-enemy-6': 'Nemico prescelto',
  'favored-enemy-14': 'Nemico prescelto',
  'natural-explorer': 'Esploratore naturale', // (2014)
  'natural-explorer-10': 'Esploratore naturale', // (2014)
  'fighting-style-ranger': 'Stile di combattimento',
  'spellcasting-ranger': 'Incantesimi',
  'ranger-archetype': 'Archetipo del ranger', // (2014)
  'primeval-awareness': 'Consapevolezza primordiale', // (2014)
  'extra-attack-ranger': 'Attacco extra',
  'lands-stride': 'Passo del territorio', // (2014)
  'hide-in-plain-sight': 'Nascondersi in piena vista', // (2014)
  vanish: 'Svanire', // (2014)
  'feral-senses': 'Sensi ferini',
  'foe-slayer': 'Sterminatore di nemici',
  // Stregone
  'spellcasting-sorcerer': 'Incantesimi',
  'sorcerous-origin': 'Origine stregonesca', // (2014)
  'font-of-magic': 'Fonte di magia',
  metamagic: 'Metamagia',
  'metamagic-10': 'Metamagia',
  'metamagic-17': 'Metamagia',
  'sorcerous-restoration': 'Ripristino stregonesco',
  // Warlock
  'otherworldly-patron': 'Patrono ultraterreno', // (2014)
  'pact-magic': 'Magia del patto',
  'eldritch-invocations': 'Suppliche occulte',
  'pact-boon': 'Dono del patto', // (2014)
  'mystic-arcanum-6': 'Arcanum mistico',
  'mystic-arcanum-7': 'Arcanum mistico',
  'mystic-arcanum-8': 'Arcanum mistico',
  'mystic-arcanum-9': 'Arcanum mistico',
